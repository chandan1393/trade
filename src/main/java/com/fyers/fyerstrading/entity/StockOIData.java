...
@Entity
@Table(name = "stock_oi_data", indexes = { @Index(name = "idx_stock_symbol_ts", columnList = "symbol, timestamp"),
		@Index(name = "idx_stock_expiry", columnList = "expiry") })
public class StockOIData {
